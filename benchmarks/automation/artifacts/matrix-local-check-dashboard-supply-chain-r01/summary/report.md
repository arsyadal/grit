...
- Run ID: `matrix-local-check-dashboard-supply-chain-r01`
- Task: `dashboard-supply-chain`
- Model: `gpt-5.4`
- Reasoning effort: `medium`
- Style module: `styles/glass-product-ui.md`
- Layout module: `layouts/dashboard-density.md`
...
- Baseline elapsed seconds: `0.0005`
- GRIT elapsed seconds: `0.0004`
